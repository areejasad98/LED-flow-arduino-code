...
/*
31 LEDs will light up one by one from left to right.

After
that, the LEDs will light up one by one from left to right, and then go out one
...
const int highestPin = 32;//the highest one attach to 
